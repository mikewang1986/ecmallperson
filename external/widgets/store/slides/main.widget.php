 ...
 */
class SlidesWidget extends Store_baseWidget
{
    var $_name = 'slides';
    ...
    function _get_data()
    {
		$data = array(
		    'model_id' => mt_rand(),
			'width'    => $this->options['width'] ? intval($this->options['width']) : 490,
			'height'   => $this->options['height'] ? intval($this->options['height']) : 210,
