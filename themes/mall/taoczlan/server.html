        ...
        <div id="footer_links2">
            ...
            <dl style="width:130px;"> 
                ...
                <dd> 
                     ...
                     <a href="index.php?app=article&act=view&article_id=21" target="_blank">服务评价规则</a>
                </dd>
            </dl>
            <dl style="width:100px;"> 
            	<dt>特色服务</dt>
                <dd> 
                     <a href="index.php?app=article&act=view&article_id=194" target="_blank">会员卡购买</a>
                </dd>
            </dl>
            <dl style="width:100px;" class="last"> 
            	<dt>商家服务</dt>
                <dd> 
                     <a href="index.php?app=article&act=view&article_id=191" target="_blank">商家服务说明</a>
                     <a href="index.php?app=article&act=view&article_id=192" target="_blank">我要开店</a>
                     <a href="index.php?app=article&act=view&article_id=193" target="_blank">商家后台</a>
                </dd>
            </dl>
            <dl style="width:200px; border-right:0px;"> 
            	<dt>联系方式</dt>
                <dd>客服电话：400-800-8000<br>
                     <span class="fl">客服QQ：540616918</span><br>
                     <span class="fl">官方淘宝店：shop36918457.taobao.com</span>
                </dd>
            </dl>
        </div>
        <div class="clear"></div>
