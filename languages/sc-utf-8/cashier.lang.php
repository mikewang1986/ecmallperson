...
return array(
	...
	'cos_order_notice'      => '您选择了 到店付款 支付方式 ，请等待卖家确认',
    'close_window'          => '关闭该页面',
    'view_order'            => '查看订单列表',
...
//  站内宝 增加语言部分 开始
	'payment_shangfutong' => '站内宝支付',	
	'payment_zhifu' => '支付密码：',		
	'payment_dongtai' => '动态密码：',	
	'payment_code_zft_no' => '卖家没开通站内宝支付，请选择其他支付方式',	
	'payment_zhaohuizhifumima' =>  '忘记支付密码',
	'payment_zhifu_desc' =>  '（默然支付密码与登陆密码一致，请自行修改!）',
	'payment_dongtai_desc' =>  '（请根据提示输入密保卡对应的三组数字!）',
	'payment_money'=>  '帐户余额：',
//  站内宝 增加语言部分 结束	
);
