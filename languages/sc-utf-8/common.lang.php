...
'goods_props'=>'商品属性',	
    ...
    'region'      => '所在地区',
    'address'      => '详细地址',
	'send_address'		=>'配送范围',//1hao5
	'operate_time'      => '营业时间',//1hao5
    'zipcode'      => '邮政编码',
    'phone'      => '电话/手机',
    'phone_tel'      => '电话号码',
    'phone_mob'      => '手机号码',
    ...
    'cancel_query' => '取消检索',
    'pay_message' => '支付消息',
    'default_site_description' => '这是一个用Vmall架设的网上商城',
    ...
    'tags' => '标签(TAG)',
    'map_location' => '地图设置', 
    'edit_map_location_successed'=>'地图编辑成功',   
    'msg_instruction' => '短消息使用格式?',
    'not_csv_file' => '您选择的文件不是CSV格式',
    'radar_title' => '商品雷达',
    'pay_priv_error' => '您的支付方式功能没有开启,请联系网站管理员开启此功能！',
    'shipping_priv_error' => '您的配送方式功能没有开启,请联系网站管理员开启此功能！',
    
    'ju' => '聚划算',
	'ju_manage'=>'聚划算管理',
	'edit_price_note'=>'注意：如果该商品参加了聚划算，则修改价格后会使其活动暂时失效，待您重新编辑聚划算活动后才生效！您确定要修改么？',
	'edit_ju_goods_price_note'=>'注意：该商品已经加入了聚划算，修改价格后将会使其活动暂时失效，待您重新编辑聚划算活动后才生效，您确定要修改么？',
    	'promotion_manage'=> '促销管理', //  add tyioocom 
    ...
    'my_membership_setting'=>'微店会员卡设置',
    'my_membership_card_info'=>'微店会员管理',
	'dongjiejine'     => '冻结金额：',
	'chongzhi' => '充值',
	'tixian' => '提现',
	'chongzhitixian'      => '充值提现',
//  站内宝v2.2.1 增加语言部分 开始
	...
	'dongtaimimacuowu'   => '动态密码错误',
	'ninbushimibaoyonghu'   => '您不是密保用户，请返回选择普通登陆',
	'ninshidongmibaoyonghu'   => '您是密保用户，请返回输入动态密码',

	'mibaoyizantingshiyong'   => '密保已暂停使用，请联系客服',
	'lijilianxikefu'   => '立即联系客服',
	'mibaoyiguoqi'   => '密保已过期，请联系客服续费或解除绑定',	
	'lijijiechubangding'   => '立即解除绑定',
...
'deposit'   => '交易宝',
	...
	'deposit_pay_status_close' => '对不起，您尚未配置好交易宝账户或者没有开启余额支付，不能付款！',
	
	'shipped'		=>	'卖家已发货',
	'accepted'	=>	'等待发货',
	'wait_admin_verify'	=>	'处理中',
	'success'			=>	'交易完成',
	'closed'		=>	'交易关闭',
