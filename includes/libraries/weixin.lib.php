...
function wxtj($access_token,$user_info)
{
  ...
  $wxch_qr_info= $wxchqr_mod->get("scene_id=".$wxuser_id);
	 ...
	 if($wxch_qr_info['media_id'])
	 {
		 
    
	 return $wxch_qr_info['media_id'];
...
$data=ROOT_PATH.'/qrcode/'.$time.'.jpg';
