...
require_once("alipay_server_config.php");
require_once("class/alipay_service.php");

/*以下参数是需要通过下单时的订单数据传入进来获得*/
//必填参数
$out_trade_no	= $_POST['user_id'].date(Ymdhms)."_".$_POST['alimoney'];				//请与贵网站订单系统中的唯一订单号匹配
$subject		= $_POST['aliorder']."服务费".$_POST['alimoney']."元";		//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
$body			= $_POST['aliorder'].'start'.$_POST['operate'].'end';		//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
...
$receive_name		= $_POST['user_name'];			//收货人姓名，如：张三
