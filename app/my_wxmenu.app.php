...
class My_wxmenuApp extends StoreadminbaseApp {
    ...
    function index() {
        if (!IS_POST) {
            ...
            if ($w_id) {
                ...
                $this->show_message('edit_weixin_successed', '返回', 'index.php?app=my_wxmenu');
            } else {
                $this->show_message(Lang::get('no_ininterface'), '错误', 'index.php?app=my_wxconfig');
            }
        }
    }
    ...
    private function getmenu() {
        ...
        $topmemu = $this->my_wxmenu_mod->find(array(
            'fields' => 'id, name, weixin_key as wkey,weixin_type,likes, weixin_keyword as keyword',
 ...
 function ajax_col()
	{
	   ...
	   $field=>$val,
	    ...
	    $this->my_wxmenu_mod->edit($id,$data);
    ...
    public function create_weixin_menu() {
       import('weixin.lib');
		...
		//echo $url="https://api.weixin.qq.com/cgi-bin/menu/create?access_token?grant_type=client_credential&appid=".$appid."&secret=".$appsecret;
