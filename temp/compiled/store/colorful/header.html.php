...
<script type="text/javascript" src="<?php echo $this->lib_base . "/" . 'pickcolor.js'; ?>" charset="utf-8"></script>
               ...
               <div class="menu-bd">
                  <div class="menu-bd-panel">
                     <div>
                        ...
                        <p><a href="<?php echo url('app=my_money'); ?>">我的资金</a></p>
                     </div>
                  </div>
               </div>
            </div>
...
<div id="store-head" class="w-full">
	<div class="w clearfix">
        <h1 class="logo">
            <a href="<?php echo $this->_var['site_url']; ?>" target="_blank" class="mlogo"><img src="<?php echo $this->_var['store']['store_logo']; ?>" /></a>
            <span class="slogo">
...
?>
                            ...
                            <dl>
                                ...
                                <dd><a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>&amp;site=<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>&amp;menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>:4" alt="QQ"></a></dd>
                                <?php endif; ?>
