...
<div id="mystore" class="w auto clearfix">
   ...
   <div class="col-main w750"> 
        <h2 class="ware_title">
            <span class="main"><?php echo htmlspecialchars($this->_var['group']['group_name']); ?></span>
            <span class="time" style="margin-left:10px;"><?php echo $this->_var['group']['state_desc']; ?></span>
        </h2>

        <div class="ware_info clearfix">
            <div class="ware_pic" style="border:1px #ccc solid"><a target="_blank" href="<?php echo url('app=goods&id=' . $this->_var['group']['goods_id']. ''); ?>"><img src="<?php echo $this->_var['goods']['default_image']; ?>" /></a></div>
