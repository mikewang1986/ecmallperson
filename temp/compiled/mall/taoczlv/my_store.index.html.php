                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                             ...
                             <tr>
                                <th>营业时间:</th>
                                <td>
                                    <p class="td_block"><input type="text" name="operate_time" class="text width_normal" id="operate_time" value="<?php echo htmlspecialchars($this->_var['store']['operate_time']); ?>" /><span class="field_notice">请在这里填写您商铺的营业时间，例：9：00-18：00</span></p><b class="padding1">*</b>
                                </td>
                            </tr>
                             <tr>
                                <th>配送范围:</th>
                                <td>
                                    <p class="td_block"><input type="text" name="send_address" class="text width_normal" id="send_address" value="<?php echo htmlspecialchars($this->_var['store']['send_address']); ?>" /><span class="field_notice">请填写您的店铺所能配送的范围及周边小区,尽可能详细!</span></p><b class="padding1">*</b>
                                </td>
                            </tr>
