...
<div id="head">
	<div id="top">
		<div class="menu">
        	<p class="link1">
            	您好,<?php echo htmlspecialchars($this->_var['visitor']['user_name']); ?>  欢迎来到<?php echo $this->_var['site_title']; ?>！
            	<?php if (! $this->_var['visitor']['user_id']): ?>
            	<a href="<?php echo url('app=member&act=login&ret_url=' . $this->_var['ret_url']. ''); ?>" style="color:#0066CC">请登录</a> | <a href="<?php echo url('app=member&act=register&ret_url=' . $this->_var['ret_url']. ''); ?>" style="color:#0066CC">免费注册</a>
            	<?php else: ?>
            	<a href="<?php echo url('app=member&act=logout'); ?>" style="color:#0066CC">退出</a>
            	<?php endif; ?>
        	</p>
        	<ul class="subnav">
            <li id="select_list">
...
?>
    ...
    <div id="nav">
		...
		<ul>
    		<li><a class="<?php if ($this->_var['index']): ?>link<?php else: ?>hover<?php endif; ?>" href="index.php">首页</a></li>
