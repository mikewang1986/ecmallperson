...
<div class="content">
    ...
    <div id="right">
        ...
        <div class="wrap" style="border-top:0;">
            <div class="public">
                ...
                <div class="information_index">
                    <div class="templet">
                        ...
                        <div class="txt">
                            ...
                            <p>当前店铺模板名称:<b><?php echo htmlspecialchars($this->_var['curr_template_name']); ?></b></p>
                            <p>当前店铺风格名称:<b><?php echo htmlspecialchars($this->_var['curr_style_name']); ?></b></p>
                            <!--<div class="btn_layer">
                                <a href="javascript:void(0);" class="btn">店铺首页</a>
                            </div>-->
                        </div>
                    </div>
                    <h5 class="motif_title">可用店铺模板</h5>
                    <div class="motif">
                        <ul>
...
?>
                            <li>
                                ...
                                <h2>店铺模板名称: <?php echo htmlspecialchars($this->_var['theme']['template_name']); ?><br />店铺风格名称: <?php echo htmlspecialchars($this->_var['theme']['style_name']); ?></h2>
                                <span>
