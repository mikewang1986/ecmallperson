            ...
            <div class="public">
                <div class="information_index">
                    <div class="templet">
                        ...
                        <div class="txt">
                            <p>店铺名称:<span><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></span><a href="<?php echo url('app=default&act=wapview&id=' . $this->_var['id']. ''); ?>" target="_blank" class="btn">店铺首页</a></p>
                            <p>当前微店模板名称:<b><?php echo htmlspecialchars($this->_var['curr_template_name']); ?></b></p>
                            <p>当前微店风格名称:<b><?php echo htmlspecialchars($this->_var['curr_style_name']); ?></b></p>
                            <!--<div class="btn_layer">
                                <a href="javascript:void(0);" class="btn">店铺首页</a>
                            </div>-->
                        </div>
                    </div>
                    <h5 class="motif_title">可用微店模板</h5>
                    <div class="motif">
                        <ul>
...
?>
                            <li>
                                ...
                                <h2>微店模板名称: <?php echo htmlspecialchars($this->_var['theme']['template_name']); ?><br />微店风格名称: <?php echo htmlspecialchars($this->_var['theme']['style_name']); ?></h2>
                                <span>
