...
?>
                    <tr class="line<?php if (($this->_foreach['_goods_f']['iteration'] == $this->_foreach['_goods_f']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['goods']['goods_id']; ?>">
                        ...
                        <!-- <a   href="javascirpt:;" ectype="dialog" dialog_id="add_datapacket" dialog_width="500" uri="<?php echo url('app=my_datapacket&act=add&goods_id=' . $this->_var['goods']['goods_id']. ''); ?>" class="set_up">加入数据包</a>
                            -->
