...
?>
                 	<li class="item mb20" <?php if ($this->_foreach['fe_group']['iteration'] % 4 == 0): ?> style="margin-right:0"<?php endif; ?>>
                 		...
                 		<div class="pic"><a target="_blank" href="<?php echo url('app=groupbuy&id=' . $this->_var['group']['group_id']. ''); ?>"><img class="lazyload" initial-url="<?php if ($this->_var['group']['group_image']): ?><?php echo $this->_var['group']['group_image']; ?><?php else: ?><?php echo $this->_var['group']['default_image']; ?><?php endif; ?>" alt="<?php echo htmlspecialchars($this->_var['group']['group_name']); ?>" /></a></div>
