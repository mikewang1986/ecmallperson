...
?>
                <li><a href="<?php echo url('app=search&brand=' . urlencode($this->_var['brand']['brand_name']). ''); ?>" target="_blank"><img src="<?php echo $this->_var['brand']['brand_logo']; ?>" width="100" height="50" alt="<?php echo $this->_var['brand']['brand_name']; ?>" /></a></li>
...
?>
            <div class="bring_forth">
                ...
                <div class="bring_forth_text w92 gleft">
                    <h2><a href="<?php echo url('app=search&brand=' . urlencode($this->_var['brand']['brand_name']). ''); ?>" target="_blank"><?php echo $this->_var['brand']['brand_name']; ?></a></h2>
                    <p>
