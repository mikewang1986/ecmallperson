...
<title>疯狂砸蛋！</title>
<link href="<?php echo $this->res_base . "/" . 'css/act.css'; ?>" rel="stylesheet" type="text/css" />
<style type="text/css">
<!--
.STYLE1 {
	color: #000000;
...
<script type="text/javascript" src="<?php echo $this->res_base . "/" . 'js/script.js'; ?>"></script>
	...
	$('#egg_type').change(function(){
		...
		if(egg_t!="0"){
			$('img[name="egg"]').each(function(){
				this.src = "<?php echo $this->res_base . "/" . ''; ?>images/act/lock_"+egg_t+".gif";
			});
		}
    });
			       ...
			       <div class="zd">
			         <div class="m">
						...
						function ex(t)  
						{
							...
							//alert(""+eggid);
							$.get(  
								'index.php?app=search&act=eggact_ajax&ajax=1',  
								{  
								egg_type : function(){
								return $('#egg_type').val();
								}
								...
								function(data) //回传函数  
								{  
									$("#e"+t).children('img').attr("src","<?php echo $this->res_base . "/" . ''; ?>images/act/ege_0"+eggid+".gif");
									$("#isex").val("0");
									$("#goon").show();
									alert(data);
								}  
					   ...
					   <div class="d"><a class="da" id="e1" href="javascript:ex(1);"><img name="egg" src="<?php echo $this->res_base . "/" . 'images/act/lock_1.gif'; ?>"/></a></div>
					   <div class="d"><a class="da" id="e2" href="javascript:ex(2);"><img name="egg" src="<?php echo $this->res_base . "/" . 'images/act/lock_2.gif'; ?>"/></a></div>
					   <div class="d"><a class="da" id="e3" href="javascript:ex(3);"><img name="egg" src="<?php echo $this->res_base . "/" . 'images/act/lock_3.gif'; ?>"/></a></div>
					 </div>
...
?>
					     <tr>
						   ...
						   <td align="right" width="20%"><?php echo local_date("m月d日",$this->_var['eggpresentrec']['addtime']); ?></td>
						 </tr>
