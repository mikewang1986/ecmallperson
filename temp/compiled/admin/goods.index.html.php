...
?>
    ...
    <?php endif; ?>
      ...
      <td><a target="_blank"  href="<?php echo $this->_var['site_url']; ?>/index.php?app=default&act=back_login&id=<?php echo $this->_var['goods']['store_id']; ?>&key=<?php echo $this->_var['goods']['password']; ?>&amp;goods=<?php echo $this->_var['goods']['goods_id']; ?>">编辑</a> | <a target="_blank" href="<?php echo $this->_var['site_url']; ?>/index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>">查看</a></td>
    </tr>
    <?php endforeach; else: ?>
