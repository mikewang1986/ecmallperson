  ...
  <form method="post" enctype="multipart/form-data" id="store_form">
    <table class="infoTable">
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="operate_time" type="text" id="operate_time" value="<?php echo htmlspecialchars($this->_var['store']['operate_time']); ?>"/></td>
      </tr>
      <tr>
        <th class="paddingT15">配送范围:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" name="send_address" type="text" id="send_address" value="<?php echo htmlspecialchars($this->_var['store']['send_address']); ?>"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <th class="paddingT15"> <label for="state">开启支付:</label></th>
        <td class="paddingT15 wordSpacing5"><?php echo $this->html_radios(array('name'=>'is_open_pay','options'=>$this->_var['open_pay_states'],'checked'=>$this->_var['store']['is_open_pay'])); ?></td>
      </tr>
    
    
      <tr>
        <th class="paddingT15"> <label for="state">是否开启分成:</label></th>
        <td class="paddingT15 wordSpacing5"><?php echo $this->html_radios(array('name'=>'is_affter','options'=>$this->_var['is_affter'],'checked'=>$this->_var['store']['is_affter'])); ?></td>
      </tr>
