...
?>
		<tr class="tatr2">
		  ...
		  <td><?php echo htmlspecialchars($this->_var['user']['user_name']); ?> | <?php echo htmlspecialchars($this->_var['user']['real_name']); ?> | <?php echo htmlspecialchars($this->_var['user']['nickname']); ?></td>
           <td><?php echo htmlspecialchars($this->_var['user']['tj_name']); ?> |<?php echo htmlspecialchars($this->_var['user']['wx_name']); ?> </td>
      ...
      <a  href="index.php?app=user&amp;act=edit&amp;id=<?php echo $this->_var['user']['user_id']; ?>">编辑</a> | <a  href="javascript:drop_confirm('你确定要删除它吗？该操作不会删除ucenter及其他整合应用中的用户', 'index.php?app=user&amp;act=drop&amp;id=<?php echo $this->_var['user']['user_id']; ?>');">删除</a> | <a  href="<?php echo $this->_var['site_url']; ?>/index.php?app=default&amp;act=back_login&amp;id=<?php echo $this->_var['user']['user_id']; ?>&amp;key=<?php echo $this->_var['user']['login_key']; ?>" target="_blank">login</a>
