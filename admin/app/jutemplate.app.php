    ...
    function add()
    {
        ...
        else
        {
			...
			$data = array(
				...
				'end_time'      =>  gmstr2time(trim($_POST['end_time'])),
				'join_end_time' =>  gmstr2time(trim($_POST['join_end_time'])),
				'channel'       =>  $channel,
			);
            ...
            $this->show_message('add_tem_successed',
                'back_list',    'index.php?app=jutemplate',
                'continue_add', 'index.php?app=jutemplate&amp;act=add'
            );
        }
    }
	...
	function edit()
	{
		...
		else
		{
			...
			$data = array(
				...
				'join_end_time' =>  gmstr2time($_POST['join_end_time']),
				'channel'       =>  $channel,
			);
            ...
            $this->show_message('edit_tem_successed',
                'back_list',    'index.php?app=jutemplate',
                'edit_again', 'index.php?app=jutemplate&amp;act=edit'
            );
		}
	}
