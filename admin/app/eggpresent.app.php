...
class EggpresentApp extends BackendApp
{
    ...
    function edit()
    {
        ...
        else
        {
            ...
            $logo             = $this->_upload_logo($eggpresent_id);
            $logo && $data['eggpresent_logo'] = $logo;
            if ($logo === false)
            {
                return;
            }
            ...
            $this->show_message('edit_successed',
                'back_list',        'index.php?app=eggpresent',
                'edit_again',    'index.php?app=eggpresent&amp;act=edit&amp;id=' . $eggpresentrec_id);
        }
    }
    ...
    function add()
    {
		...
		else
        {
            ...
            $logo && $this->_eggpresent_mod->edit($eggpresent_id, array('eggpresent_logo' => $logo)); //将logo地址记下

            $this->show_message('add_successed',
                'back_list',    'index.php?app=eggpresent',
                'continue_add', 'index.php?app=eggpresent&amp;act=add'
            );
        }
    }
}
