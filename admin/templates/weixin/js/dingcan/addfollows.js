...
$(function(){
	...
	check_tuwen(1);
	var url = "index.php?app=my_wxfollow&act=showfollow";
...
function choseImg(){
	...
	$('.zhe').show();
	$('.imgbox a').remove();
	var url = "index.php?app=my_wxfollow&act=allimages";
	$.post(url,null,function(data){
		$.each(data,function(i,v){
...
function delImg(num){
	...
	var url = "index.php?app=my_wxfollow&act=delimage";
...
function btnsave(num,count){
	...
	if(ktype==1){
		...
		var url = "index.php?app=my_wxfollow&act=save";
